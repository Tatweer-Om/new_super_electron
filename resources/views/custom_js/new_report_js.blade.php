...
//     // Initialize DataTables and other existing functionalities...
...
//     $('#monthSelect, #yearSelect').on('change', updateFormDates);

//     // If initial values are set, update the dates accordingly
//     updateFormDates();

//     // Initialize other DataTables functionalities and scripts...

//     // Example of DataTable initialization for another table
...
//         $('#date_from').val(lastMonthDates.start);
//         $('#to_date').val(lastMonthDates.end);
//         $('.form_data').submit();
//     }
...
//             var endDate = new Date(year, month - 1, day); // Same day as end date

//             $('#date_from').val(formatDate(selectedDate));
//             $('#to_date').val(formatDate(endDate));
//         }
//     }

//     $('#monthSelect, #yearSelect, #daySelect').on('change', updateFormDates);
...
$(document).ready(function () {
    ...
    // Update form dates based on selected month, year, and day
    function formatDate(date) {
        var dd = date.getDate();
        var mm = date.getMonth() + 1; // January is 0!
        var yyyy = date.getFullYear();
