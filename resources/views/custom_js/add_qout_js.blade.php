...
function addNewServiceRow() {
    ...
    select=`<input type="text" class="form-control bg-light border-0 service_select" id="service_select-1" placeholder="Select service" name="service_select[]" />`;
...
function addNewRow() {
    ...
    var select_product=`<input type="text" class="form-control bg-light border-0 product_select" id="product_select-1" placeholder="Select Product" name="product_select[]" />`;
