    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                ...
                data-bs-target="#add_offer_modal"><i class="fa fa-plus me-2"></i>{{ trans('messages.add_offer_lang', [], session('locale')) }}</a>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    <input type="checkbox" id="box" onchange="toggleTaxSign()" name="offer_discount_type"> <span id="tax_sign"> %</span>
                                                </div>
                                                </div>
                                                <input type="text" class="form-control offer_discount" name="offer_discount">
                                            </div>
                                        </div>

                                        <div class="col-lg-4 col-sm-10 col-10">
                                            <label class="col-lg-6">{{ trans('messages.choose_brand_lang', [], session('locale')) }}</label>
                                            <select class="searchable_select select2 offer_brand" name="offer_brand[]" multiple>
                                        ...
                                        <div class="col-lg-4 col-sm-10 col-10">
                                            <label class="col-lg-6">{{ trans('messages.choose_category_lang', [], session('locale')) }}</label>
                                            <select class="searchable_select select2 offer_category" id="my_select" name="offer_category[]" multiple>
                                        ...
                                        <div class="col-lg-4 col-sm-10 col-10">
                                            <label class="col-lg-6">{{ trans('messages.choose_product_lang', [], session('locale')) }}</label>
                                            <select class="searchable_select select2 offer_product" name="offer_product[]" multiple>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-6 col-12">
                                            <div class="row product_radio_class">
                                                <label class="col-lg-6">{{ trans('messages.offer_type_lang', [], session('locale')) }}</label>
                                                <div class="col-lg-12">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_all" value="1" checked>
                                                        <label class="form-check-label" for="offer_type_all">
                                                            {{ trans('messages.all_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_student" value="2">
                                                        <label class="form-check-label" for="offer_type_student">
                                                            {{ trans('messages.offer_student_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_teacher" value="3">
                                                        <label class="form-check-label" for="offer_type_teacher">
                                                            {{ trans('messages.offer_teacher_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_employee" value="4">
                                                        <label class="form-check-label" for="offer_type_employee">
                                                            {{ trans('messages.offer_employee_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_male" value="5">
                                                        <label class="form-check-label" for="offer_type_male">
                                                            {{ trans('messages.male_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input offer_type" type="checkbox" name="offer_type[]" id="offer_type_female" value="6">
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-12 col-sm-6 col-12 ">
                                            <div class="row product_radio_class" >
                                                <label class="col-lg-6">{{ trans('messages.offer_category_lang', [], session('locale')) }}</label>
                                                <div class="col-lg-12">
                                                    {{-- <div class=" form-check form-check-inline">
                                                    ...
                                                    <div class=" form-check form-check-inline">
                                                        <input class="form-check-input offer_apply_maint" type="checkbox"  name="offer_apply[]" id="offer_type_maint" value="2">
                                                        <label class="form-check-label" for="offer_type_maint">
                                                            {{ trans('messages.maintenance_student_lang', [], session('locale')) }}
                                                        </label>
                                                    </div>
                                                    <div class=" form-check form-check-inline">
                                                        <input class="form-check-input offer_apply_product" type="checkbox"  name="offer_apply[]" id="offer_type_product" value="3" >
