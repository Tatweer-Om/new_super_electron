                                    ...
                                    <div class="form-group">
										...
										<div class="row">
											<div class="col-lg-10 col-sm-10 col-10">
                                                <select class="searchable_select select2 supplier_id" name="supplier_id">
                            ...
                            <div class="stocks_class stock_no_1">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-sm-10 col-10">
                                                    <select class="searchable_select select2 store_id_1" name="store_id[]">
                                                        <option value="">Choose...</option>
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-sm-10 col-10">
                                                    <select class="searchable_select select2 category_id_1" name="category_id[]">
                                                        <option value="">Choose...</option>
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-sm-10 col-10">
                                                    <select class="searchable_select select2 brand_id_1" name="brand_id[]">
                                                        <option value="">Choose...</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">OMR</span>
                                            <input type="text" class="form-control purchase_price_1 isnumber" onkeyup="get_sale_price(1)" name="purchase_price[]">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new input-group"  data-provides="fileinput">
                                                <span class="input-group-addon fileupload btn btn-submit" style="width: 100%">
                                                    <input type="file" class="image" onchange="return fileValidation('stock_img_1','stock_img_tag_1')"   name="stock_image[]" id="stock_img_1"  >
                                                </span>
