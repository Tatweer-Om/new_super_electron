...
@section('main')
    @push('title')
        <title>{{ trans('message.proposal_lang', [], session('locale')) }}</title>
    @endpush
            ...
            <div class="page-header settings-pg-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        ...
                        <h6>Write down the proposal's terms</h6>
                    </div>
                </div>
                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    <a href="javascript:void(0);" class="active subdrop"><i
                                                            ...
                                                            class="menu-arrow"></span></a>
                                                    <ul>
                                                        <li><a href="{{ url('proposal_setting') }}" class="active">Terms of Refernce</a></li>
                        ...
                        <div class="settings-page-wrap">
                            <form action="" id="proposal" method="Post">
                                ...
                                <div class="setting-title">
                                    <h4>Proposal Terms of Reference </h4>
                                </div>
