...
@section('main')
    @push('title')
        <title>{{ trans('message.inspection_lang', [], session('locale')) }}</title>
    @endpush
            ...
            <div class="page-header settings-pg-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>Inspection Agreement Conditions</h4>
                        <h6>Write down the Terms and Conditions</h6>
                    </div>
                </div>
                                    ...
                                    <ul>
                                        <li class="submenu-open">
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    <a href="javascript:void(0);" class="active subdrop"><i data-feather="archive" ></i><span>Maintenance Agreement
                                                        </span><span class="menu-arrow"></span></a>
                                                    <ul>
                                                        <li><a href="{{ url('inspection_setting') }}" class="active">Inspection Agreement</a></li>
