...
@section('main')
    @push('title')
        <title>{{ trans('messages.qout_setting_lang', [], session('locale')) }} </title>
    @endpush
            ...
            <div class="page-header settings-pg-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        ...
                        <h6> {{ trans('messages.write_&_qout_lang', [], session('locale')) }}</h6>
                    </div>
                </div>
                                            ...
                                            <ul>
                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ url('qout_setting') }}" class="active"> {{ trans('messages.qout_detail_lang', [], session('locale')) }}</a></li>
                        ...
                        <div class="settings-page-wrap">
                            <form action="" id="qout">
                                <div class="setting-title">
                                    <h4> {{ trans('messages.qout_terms_lang', [], session('locale')) }}</h4>
                                </div>
