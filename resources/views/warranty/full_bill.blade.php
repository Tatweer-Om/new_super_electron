     ...
     <div class="container-fluid" style="background-color: #fff">
         ...
         <div class="row" style="padding: 52px;">
            ...
            <table width="100%" style="border-collapse: collapse;">
                <tr>
                    ...
                    <th class="bold-header" style="width: 15%; border: 1px solid #d3cccc5e; text-align: center;">S.N/IMEI</th>
                    <th class="bold-header" style="width: 25%; border: 1px solid #d3cccc5e; text-align: center;">Product Detail</th>
                    <th class="bold-header" style="width: 15%; border: 1px solid #d3cccc5e; text-align: center;">Warranty Type</th>
                    <th class="bold-header" style="width: 20%; border: 1px solid #d3cccc5e; text-align: center;">Warranty Validity</th>
                    <th class="bold-header" style="width: 20%; border: 1px solid #d3cccc5e; text-align: center;">Total Price</th>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding: 5px; border: 1px solid #d3cccc5e; text-align: center;">
                        {{ $data['warranty']->item_imei ?? 'N/A' }}
                    </td>
                    <td style="padding: 5px; border: 1px solid #d3cccc5e; text-align: center;">
                        <span>
                            {{ $data['product_name_ar'] ?? '' }} {{ $data['product_name'] ?? 'N/A' }} <br>
                            <small>({{ $data['warranty']->quantity ?? 'N/A' }} Item)</small><br>
                            <span>{{ $data['warranty']->item_barcode ?? 'N/A' }}</span>
                        </span>
                    </td>
                    <td style="padding: 5px; border: 1px solid #d3cccc5e; text-align: center;">
                        <span>{{ $data['warranty']->warranty_type == 1 ? 'shop' : 'agent' }}</span>
                    </td>
                    <td style="padding: 5px; border: 1px solid #d3cccc5e; text-align: center;">
                        <span>
                            {{ $data['warranty']->warranty_days ?? 'N/A' }} days<br>
                            {{ $created_at->addDays($data['warranty']->warranty_days)->format('Y-m-d') }}<br>
                            @php
                    ...
                    <td style="padding: 5px; border: 1px solid #d3cccc5e; text-align: center;">{{ $data['warranty']->total_price ?? 'N/A' }} </td>
                </tr>
                @php $total_price += $data['warranty']->total_price ?? 0; @endphp
                @endforeach
                ...
                <!-- Total Price -->
                <tr>
                    <td colspan="5" class="bold-header" style="border: 1px solid #d3cccc5e; text-align: right;">Total Price:</td>
        ...
        <div class="row">
            <div class="col-lg-12" style="text-align: center;">
                ...
                <div class="bold-header" style="display: inline-block; width: 10%;">S.N/IMEI</div>
                <div class="bold-header" style="display: inline-block; width: 20%;">Product Detail</div>
                <div class="bold-header" style="display: inline-block; width: 10%;">Warranty Type</div>
                <div class="bold-header" style="display: inline-block; width: 15%;">Warranty Validity</div>
                <div class="bold-header" style="display: inline-block; width: 10%;">Total Price</div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12" style="text-align: center;">
                ...
                <div style="display: inline-block; width: 10%;">{{ $data['warranty']->item_imei ?? 'N/A' }}</div>
                ...
                <div style="display: inline-block; width: 10%;">{{ $data['warranty']->warranty_type == 1 ? 'shop' : 'agent' }}</div>
                ...
                <div style="display: inline-block; width: 10%;">{{ $data['warranty']->total_price ?? 'N/A' }} </div>
            </div>
        </div>
        @php $total_price += $data['warranty']->total_price ?? 0; @endphp
        @endforeach
        ...
        <div class="row">
            <div class="col-lg-12" style="text-align: right; margin-top: 10px;">
                <div class="bold-header" style="display: inline-block; width: 85%;">Total Price:</div>
                <div style="display: inline-block; width: 15%;">{{ number_format($total_price, 3) }} </div>
            </div>
        </div>
