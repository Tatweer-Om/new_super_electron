...
<body>
    ...
    <div class="page-wrapper" style="margin: 0 0 0 0;">
           ...
           <div class="d-flex align-items-center">
                <div class="position-relative daterange-wraper me-2">
                    <div class="input-groupicon calender-input">
                        <select class="repairing_type form-control" disabled id="repairing_type" name="repairing_type">
        ...
        <div class="welcome d-lg-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="col-lg-4 col-sm-6 col-12">
                        ...
                        <input type="text" readonly class="form-control warranty_day"  value="<?php echo $repair_detail->warranty_day; ?>" name="warranty_day">
        ...
        @php }  @endphp
        @php if(!empty($issuetype_data)){ @endphp
            <div class="row">
                <div class="col-sm-12 col-md-12 col-xl-6 d-flex">
                    <div class="card flex-fill default-cover w-100 mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="table-responsive no-pagination">
                                <table class="table no-footer">
                                    ...
                                    <tbody id="issuetype_tbody">
                                        @php echo $issuetype_data; @endphp
                                    </tbody>
                                </table>
                            </div>
                        </div>
