            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h4> {{ trans('messages.product_service_list_lang', [], session('locale')) }}</h4>
                        <h6>{{ trans('messages.search_product_service_lang', [], session('locale')) }}</h6>
                    </div>
                    <div class="page-btn">
                        <a href="javascript:void(0);" class="btn btn-added" data-bs-toggle="modal"
                        data-bs-target="#add_service_modal"><i class="fa fa-plus me-2"></i>{{ trans('messages.service_lang', [], session('locale')) }}</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="all_service" class="table  ">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        ...
                                        <th>{{ trans('messages.service_detail_lang',[],session('locale')) }}</th>
