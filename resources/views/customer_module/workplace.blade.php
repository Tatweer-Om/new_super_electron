...
@section('main')
@push('title')
<title>{{ trans('messages.workplaces_lang', [], session('locale')) }}</title>
@endpush
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h4> {{ trans('messages.workplace_list_lang', [], session('locale')) }}</h4>
                        <h6>{{ trans('messages.search_workplace_lang', [], session('locale')) }}</h6>
                    </div>
                    <div class="page-btn">
                        <a href="javascript:void(0);" class="btn btn-added" data-bs-toggle="modal"
                        data-bs-target="#add_workplace_modal"><i class="fa fa-plus me-2"></i>{{ trans('messages.workplace_lang', [], session('locale')) }}</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="all_workplace" class="table  ">
                                <thead>
                                    <tr>
                                        <th>#</th>
